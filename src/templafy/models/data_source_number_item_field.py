...
T = TypeVar("T", bound="DataSourceNumberItemField")


@_attrs_define
class DataSourceNumberItemField:
    """Example:
    ...
    Attributes:
        ...
        value (Union[Unset, float]): The value of the field with the precision of 2 decimal places.
    """
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        data_source_number_item_field = cls(
            type_=type_,
            data_source_field_id=data_source_field_id,
            value=value,
        )

        data_source_number_item_field.additional_properties = d

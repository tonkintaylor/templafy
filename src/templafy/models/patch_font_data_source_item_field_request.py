...
T = TypeVar("T", bound="PatchFontDataSourceItemFieldRequest")


@_attrs_define
class PatchFontDataSourceItemFieldRequest:
    """Example:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        patch_font_data_source_item_field_request = cls(
            type_=type_,
        ...
        patch_font_data_source_item_field_request.additional_properties = d

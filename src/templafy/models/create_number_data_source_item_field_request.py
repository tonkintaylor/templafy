...
T = TypeVar("T", bound="CreateNumberDataSourceItemFieldRequest")


@_attrs_define
class CreateNumberDataSourceItemFieldRequest:
    """Example:
        {'type': 'number', 'dataSourceFieldId': 1, 'value': 123.45}
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        create_number_data_source_item_field_request = cls(
            type_=type_,
            data_source_field_id=data_source_field_id,
            value=value,
        )

        create_number_data_source_item_field_request.additional_properties = d
        return create_number_data_source_item_field_request

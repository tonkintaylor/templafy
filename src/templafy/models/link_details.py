...
from templafy.models.asset_state_without_file import AssetStateWithoutFile
from templafy.types import UNSET, Unset

T = TypeVar("T", bound="LinkDetails")
...
class LinkDetails:
    ...
    tags (list[str]):
    url (str):
    navigation_path (str): Hierarchical path in lowercase based on the location of a link. E.g.
        "folder-a/folder-b/_my-link" when the location is "Folder A > Folder B > My Link"
    modified_at (str): Date and time in ISO 8601 format of when the asset was last modified
    asset_state (AssetStateWithoutFile): The current state of the asset
    ...
    navigation_path: str
    modified_at: str
    asset_state: AssetStateWithoutFile
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        asset_state = AssetStateWithoutFile(d.pop("assetState"))

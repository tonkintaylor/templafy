...
T = TypeVar("T", bound="PatchImageDataSourceItemFieldRequest")


@_attrs_define
class PatchImageDataSourceItemFieldRequest:
    """Example:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        patch_image_data_source_item_field_request = cls(
            type_=type_,
        ...
        patch_image_data_source_item_field_request.additional_properties = d
        return patch_image_data_source_item_field_request

...
T = TypeVar("T", bound="CreateTextDataSourceItemFieldRequest")


@_attrs_define
class CreateTextDataSourceItemFieldRequest:
    """Example:
        {'type': 'text', 'dataSourceFieldId': 0, 'value': 'Sample text'}
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        create_text_data_source_item_field_request = cls(
            type_=type_,
            data_source_field_id=data_source_field_id,
            value=value,
        )

        create_text_data_source_item_field_request.additional_properties = d

...
T = TypeVar("T", bound="PatchColorThemeDataSourceItemFieldRequest")


@_attrs_define
class PatchColorThemeDataSourceItemFieldRequest:
    """Example:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        patch_color_theme_data_source_item_field_request = cls(
            type_=type_,
            data_source_field_id=data_source_field_id,
            xml_value=xml_value,
        )

        patch_color_theme_data_source_item_field_request.additional_properties = d
        return patch_color_theme_data_source_item_field_request

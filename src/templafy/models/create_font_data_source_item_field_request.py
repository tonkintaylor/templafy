...
T = TypeVar("T", bound="CreateFontDataSourceItemFieldRequest")


@_attrs_define
class CreateFontDataSourceItemFieldRequest:
    """Example:
        {'type': 'font', 'dataSourceFieldId': 4, 'fileName': 'best-font', 'fileUrl': 'https://allfonts.com/best-font'}
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        create_font_data_source_item_field_request = cls(
            type_=type_,
        ...
        create_font_data_source_item_field_request.additional_properties = d
        return create_font_data_source_item_field_request

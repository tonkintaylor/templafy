...
) -> Any | NotFoundProblemDetails | None:
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[Any | NotFoundProblemDetails]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    """Deletes an existing field from a data source item.

     Deletes an existing field from the specified data source item contained in the specified data
    source.

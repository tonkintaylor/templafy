...
) -> Any | list["Library"] | None:
    if response.status_code == 200:
        response_200 = []
        _response_200 = response.json()
        for response_200_item_data in _response_200:
            response_200_item = Library.from_dict(response_200_item_data)
...
def sync_detailed(
    *,
    ...
    Returns:
        Response[Union[Any, list['Library']]]
    """

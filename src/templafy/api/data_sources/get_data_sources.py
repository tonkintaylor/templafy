...
def sync_detailed(
    *,
    ...
    """Lists all existing data sources.
     ...
     Returns a list of all data sources and the schema of their fields.
    ...
    Returns:
        Response[Union[Any, list['DataSource']]]
    """

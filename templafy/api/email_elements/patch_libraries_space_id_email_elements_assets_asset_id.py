...
from ...models.patch_libraries_space_id_email_elements_assets_asset_id_body import (
...
def _get_kwargs(
    ...
    asset_id: int,
    *,
    body: PatchLibrariesSpaceIdEmailElementsAssetsAssetIdBody,
) -> dict[str, Any]:
...
def sync_detailed(
    ...
    *,
    ...
    """Updates the email element asset.

...
from ...models.patch_libraries_space_id_slides_assets_asset_id_body import PatchLibrariesSpaceIdSlidesAssetsAssetIdBody
...
def _get_kwargs(
    ...
    asset_id: int,
    *,
    body: PatchLibrariesSpaceIdSlidesAssetsAssetIdBody,
) -> dict[str, Any]:
...
def sync_detailed(
    ...
    *,
    ...
    """Updates the slide asset.

     Only one file can be attached to the request body. The supported file format is .PPTX. Slides are
    limited to the following properties that can be updated: Name, Tags, ExternalData

...
from ...models.patch_libraries_space_id_spreadsheets_assets_asset_id_body import (
...
def _get_kwargs(
    ...
    asset_id: int,
    *,
    body: PatchLibrariesSpaceIdSpreadsheetsAssetsAssetIdBody,
) -> dict[str, Any]:
...
def sync_detailed(
    ...
    *,
    ...
    """Updates the spreadsheet template.

     Only one file can be attached to the request body. The supported file formats are .XLSX and .XLSM
    for macro-enabled spreadsheets.

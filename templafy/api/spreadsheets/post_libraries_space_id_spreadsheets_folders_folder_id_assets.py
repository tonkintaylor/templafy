...
from ...models.post_libraries_space_id_spreadsheets_folders_folder_id_assets_body import (
...
def _get_kwargs(
    ...
    folder_id: int,
    *,
    body: PostLibrariesSpaceIdSpreadsheetsFoldersFolderIdAssetsBody,
) -> dict[str, Any]:
...
) -> Optional[Union[Any, ConflictProblemDetails, NotFoundProblemDetails, ValidationProblemDetails, int]]:
...
def sync_detailed(
    ...
    *,
    ...
    """Uploads the spreadsheet template.

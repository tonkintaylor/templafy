...
from ...models.patch_libraries_space_id_images_assets_asset_id_body import PatchLibrariesSpaceIdImagesAssetsAssetIdBody
...
def _get_kwargs(
    ...
    asset_id: int,
    *,
    body: PatchLibrariesSpaceIdImagesAssetsAssetIdBody,
) -> dict[str, Any]:

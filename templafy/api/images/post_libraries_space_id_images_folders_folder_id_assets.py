...
from ...models.post_libraries_space_id_images_folders_folder_id_assets_body import (
...
def _get_kwargs(
    ...
    folder_id: int,
    *,
    body: PostLibrariesSpaceIdImagesFoldersFolderIdAssetsBody,
) -> dict[str, Any]:
...
def sync_detailed(
    ...
    *,
    ...
    """Uploads the image file.
     ...
     Only one file can be attached to the request body. The supported file formats are .JPG/.JPEG, .PNG,
    .GIF and .SVG

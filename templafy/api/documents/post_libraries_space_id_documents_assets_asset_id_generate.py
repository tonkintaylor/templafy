...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": f"/libraries/{space_id}/documents/assets/{asset_id}/generate",
    }
...
def sync_detailed(
    ...
    *,
    ...
    """Generates a document from a template and returns information about the file, which includes the
    download url.

...
from ...models.post_libraries_space_id_documents_folders_folder_id_assets_body import (
...
def _get_kwargs(
    ...
    folder_id: int,
    *,
    body: PostLibrariesSpaceIdDocumentsFoldersFolderIdAssetsBody,
) -> dict[str, Any]:

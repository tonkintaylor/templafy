...
from ...models.patch_libraries_space_id_pdfs_assets_asset_id_body import PatchLibrariesSpaceIdPdfsAssetsAssetIdBody
...
def _get_kwargs(
    ...
    asset_id: int,
    *,
    body: PatchLibrariesSpaceIdPdfsAssetsAssetIdBody,
) -> dict[str, Any]:
    headers: dict[str, Any] = {}

    _kwargs: dict[str, Any] = {
        "method": "patch",
        "url": f"/libraries/{space_id}/pdfs/assets/{asset_id}",
    }
...
def sync_detailed(
    ...
    *,
    ...
    """Updates the pdf asset.

     Only one file can be attached to the request body. The supported file format is .PDF

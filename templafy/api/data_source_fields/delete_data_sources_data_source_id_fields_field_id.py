...
from ...models.data_source_object_locked_problem_details import DataSourceObjectLockedProblemDetails
...
) -> Optional[Union[Any, DataSourceObjectLockedProblemDetails, NotFoundProblemDetails]]:

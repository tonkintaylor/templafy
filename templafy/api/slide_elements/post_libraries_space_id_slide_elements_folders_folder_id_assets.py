...
from ...models.post_libraries_space_id_slide_elements_folders_folder_id_assets_body import (
...
def _get_kwargs(
    ...
    folder_id: int,
    *,
    body: PostLibrariesSpaceIdSlideElementsFoldersFolderIdAssetsBody,
) -> dict[str, Any]:
...
def sync_detailed(
    ...
    *,
    ...
    """Uploads the slide element file.
     ...
     Only one file can be attached to the request body. The supported file format is .PPTX

...
from ...models.patch_libraries_space_id_slide_elements_assets_asset_id_body import (
...
def _get_kwargs(
    ...
    asset_id: int,
    *,
    body: PatchLibrariesSpaceIdSlideElementsAssetsAssetIdBody,
) -> dict[str, Any]:
...
) -> Optional[Union[Any, ConflictProblemDetails, NotFoundProblemDetails, ValidationProblemDetails]]:
...
def sync_detailed(
    ...
    *,
    ...
    """Updates the slide element asset.
     ...
     Only one file can be attached to the request body. The supported file format is .PPTX. Slide
    elements are limited to the following properties that can be updated: Name, Tags, ExternalData

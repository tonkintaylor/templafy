...
from ...models.post_libraries_space_id_text_elements_folders_folder_id_assets_body import (
...
def _get_kwargs(
    ...
    folder_id: int,
    *,
    body: PostLibrariesSpaceIdTextElementsFoldersFolderIdAssetsBody,
) -> dict[str, Any]:

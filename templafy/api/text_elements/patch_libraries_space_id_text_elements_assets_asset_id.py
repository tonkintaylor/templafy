...
from ...models.patch_libraries_space_id_text_elements_assets_asset_id_body import (
...
def _get_kwargs(
    ...
    asset_id: int,
    *,
    body: PatchLibrariesSpaceIdTextElementsAssetsAssetIdBody,
) -> dict[str, Any]:
...
def sync_detailed(
    ...
    *,
    ...
    """Updates the text element asset.

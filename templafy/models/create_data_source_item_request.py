...
if TYPE_CHECKING:
    ...
    from templafy.models.create_font_data_source_item_field_request import CreateFontDataSourceItemFieldRequest
    from templafy.models.create_image_data_source_item_field_request import CreateImageDataSourceItemFieldRequest
    from templafy.models.create_number_data_source_item_field_request import CreateNumberDataSourceItemFieldRequest
    from templafy.models.create_reference_data_source_item_field_request import (
        CreateReferenceDataSourceItemFieldRequest,
    )
    from templafy.models.create_text_data_source_item_field_request import CreateTextDataSourceItemFieldRequest
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.fields, Unset):
            ...
            for fields_type_0_item_data in self.fields:
                ...
                if isinstance(fields_type_0_item_data, CreateTextDataSourceItemFieldRequest):
                    fields_type_0_item = fields_type_0_item_data.to_dict()
                elif isinstance(fields_type_0_item_data, CreateNumberDataSourceItemFieldRequest):
                    fields_type_0_item = fields_type_0_item_data.to_dict()
                elif isinstance(fields_type_0_item_data, CreateReferenceDataSourceItemFieldRequest):
                    fields_type_0_item = fields_type_0_item_data.to_dict()
                elif isinstance(fields_type_0_item_data, CreateImageDataSourceItemFieldRequest):
                    fields_type_0_item = fields_type_0_item_data.to_dict()
                elif isinstance(fields_type_0_item_data, CreateFontDataSourceItemFieldRequest):
                    fields_type_0_item = fields_type_0_item_data.to_dict()
                else:
                    fields_type_0_item = fields_type_0_item_data.to_dict()
                    ...
                    def _parse_fields_type_0_item(
                        ...
                        try:
                            if not isinstance(data, dict):
                                raise TypeError()
                            fields_type_0_item_type_0 = CreateTextDataSourceItemFieldRequest.from_dict(data)
                        ...
                        try:
                            if not isinstance(data, dict):
                                raise TypeError()
                            fields_type_0_item_type_1 = CreateNumberDataSourceItemFieldRequest.from_dict(data)
                        ...
                        try:
                            if not isinstance(data, dict):
                                raise TypeError()
                            fields_type_0_item_type_2 = CreateReferenceDataSourceItemFieldRequest.from_dict(data)
                        ...
                        try:
                            if not isinstance(data, dict):
                                raise TypeError()
                            fields_type_0_item_type_3 = CreateImageDataSourceItemFieldRequest.from_dict(data)
                        ...
                        try:
                            if not isinstance(data, dict):
                                raise TypeError()
                            fields_type_0_item_type_4 = CreateFontDataSourceItemFieldRequest.from_dict(data)
                        ...
                        if not isinstance(data, dict):
                            raise TypeError()
                        fields_type_0_item_type_5 = CreateColorThemeDataSourceItemFieldRequest.from_dict(data)

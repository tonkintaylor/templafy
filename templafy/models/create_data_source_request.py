...
if TYPE_CHECKING:
    from templafy.models.create_image_field_schema_request import CreateImageFieldSchemaRequest
    from templafy.models.create_number_field_schema_request import CreateNumberFieldSchemaRequest
    from templafy.models.create_reference_field_schema_request import CreateReferenceFieldSchemaRequest
    from templafy.models.create_text_field_schema_request import CreateTextFieldSchemaRequest
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.fields, Unset):
            ...
            for fields_type_0_item_data in self.fields:
                ...
                if isinstance(fields_type_0_item_data, CreateTextFieldSchemaRequest):
                    fields_type_0_item = fields_type_0_item_data.to_dict()
                elif isinstance(fields_type_0_item_data, CreateNumberFieldSchemaRequest):
                    fields_type_0_item = fields_type_0_item_data.to_dict()
                elif isinstance(fields_type_0_item_data, CreateImageFieldSchemaRequest):
                    fields_type_0_item = fields_type_0_item_data.to_dict()
                else:
                    fields_type_0_item = fields_type_0_item_data.to_dict()
                    ...
                    def _parse_fields_type_0_item(
                        ...
                        try:
                            if not isinstance(data, dict):
                                raise TypeError()
                            fields_type_0_item_type_0 = CreateTextFieldSchemaRequest.from_dict(data)
                        ...
                        try:
                            if not isinstance(data, dict):
                                raise TypeError()
                            fields_type_0_item_type_1 = CreateNumberFieldSchemaRequest.from_dict(data)
                        ...
                        try:
                            if not isinstance(data, dict):
                                raise TypeError()
                            fields_type_0_item_type_2 = CreateImageFieldSchemaRequest.from_dict(data)
                        ...
                        if not isinstance(data, dict):
                            raise TypeError()
                        fields_type_0_item_type_3 = CreateReferenceFieldSchemaRequest.from_dict(data)

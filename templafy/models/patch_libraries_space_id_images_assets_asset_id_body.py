...
T = TypeVar("T", bound="PatchLibrariesSpaceIdImagesAssetsAssetIdBody")


@_attrs_define
class PatchLibrariesSpaceIdImagesAssetsAssetIdBody:
    """
    Attributes:
        automatic_tags (Union[Unset, list[str]]): Automatic tags are system-generated tags that can only be removed
            partially or fully. Adding a new tag or changing the existing ones is not allowed.
    ...
    automatic_tags: Union[Unset, list[str]] = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        automatic_tags: Union[Unset, list[str]] = UNSET
        if not isinstance(self.automatic_tags, Unset):
        ...
        field_dict.update({})
        if automatic_tags is not UNSET:
            field_dict["AutomaticTags"] = automatic_tags
    ...
    def to_multipart(self) -> types.RequestFiles:
        ...
        if not isinstance(self.automatic_tags, Unset):
            for automatic_tags_item_element in self.automatic_tags:
                files.append(("AutomaticTags", (None, str(automatic_tags_item_element).encode(), "text/plain")))

        if not isinstance(self.folder_id, Unset):
            files.append(("FolderId", (None, str(self.folder_id).encode(), "text/plain")))
        ...
        if not isinstance(self.external_data, Unset):
            files.append(("ExternalData", (None, str(self.external_data).encode(), "text/plain")))
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        d = dict(src_dict)
        automatic_tags = cast(list[str], d.pop("AutomaticTags", UNSET))
        ...
        patch_libraries_space_id_images_assets_asset_id_body = cls(
        ...
        patch_libraries_space_id_images_assets_asset_id_body.additional_properties = d
        return patch_libraries_space_id_images_assets_asset_id_body

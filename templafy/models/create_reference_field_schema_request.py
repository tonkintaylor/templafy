...
class CreateReferenceFieldSchemaRequest:
    ...
    default_referenced_item_id: Union[None, Unset, int] = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        default_referenced_item_id: Union[None, Unset, int]
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_default_referenced_item_id(data: object) -> Union[None, Unset, int]:
            if data is None:
                return data
        ...
        default_referenced_item_id = _parse_default_referenced_item_id(d.pop("defaultReferencedItemId", UNSET))

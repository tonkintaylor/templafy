...
from templafy.models.asset_file_state_without_previews import AssetFileStateWithoutPreviews
from templafy.types import UNSET, Unset

T = TypeVar("T", bound="EmailElementDetails")


@_attrs_define
class EmailElementDetails:
    """
    Attributes:
        ...
        download_url (str): Generated temporary access URL for content downloading with 302 response code
        navigation_path (str): Hierarchical path in lowercase based on the location of a email element. E.g.
            "folder-a/folder-b/_my-email-element" when the location is "Folder A > Folder B > My Email Element"

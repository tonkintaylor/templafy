...
T = TypeVar("T", bound="PatchLibrariesSpaceIdEmailElementsAssetsAssetIdBody")


@_attrs_define
class PatchLibrariesSpaceIdEmailElementsAssetsAssetIdBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        patch_libraries_space_id_email_elements_assets_asset_id_body = cls(
            folder_id=folder_id,
            name=name,
        ...
        patch_libraries_space_id_email_elements_assets_asset_id_body.additional_properties = d

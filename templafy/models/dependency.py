...
class Dependency:
    ...
    source_entity_type: Union[Unset, SourceEntityType] = UNSET
    source_entity_id: Union[None, Unset, str] = UNSET
    description: Union[None, Unset, str] = UNSET

    def to_dict(self) -> dict[str, Any]:
        source_entity_type: Union[Unset, str] = UNSET
        if not isinstance(self.source_entity_type, Unset):
            source_entity_type = self.source_entity_type.value

        source_entity_id: Union[None, Unset, str]
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_source_entity_id(data: object) -> Union[None, Unset, str]:
            if data is None:
                return data

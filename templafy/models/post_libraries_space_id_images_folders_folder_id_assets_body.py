...
T = TypeVar("T", bound="PostLibrariesSpaceIdImagesFoldersFolderIdAssetsBody")


@_attrs_define
class PostLibrariesSpaceIdImagesFoldersFolderIdAssetsBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        post_libraries_space_id_images_folders_folder_id_assets_body = cls(
            file=file,
            name=name,
        ...
        post_libraries_space_id_images_folders_folder_id_assets_body.additional_properties = d
        return post_libraries_space_id_images_folders_folder_id_assets_body

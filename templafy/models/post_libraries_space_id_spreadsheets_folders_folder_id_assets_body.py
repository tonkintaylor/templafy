...
T = TypeVar("T", bound="PostLibrariesSpaceIdSpreadsheetsFoldersFolderIdAssetsBody")


@_attrs_define
class PostLibrariesSpaceIdSpreadsheetsFoldersFolderIdAssetsBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        post_libraries_space_id_spreadsheets_folders_folder_id_assets_body = cls(
            file=file,
            name=name,
        ...
        post_libraries_space_id_spreadsheets_folders_folder_id_assets_body.additional_properties = d
        return post_libraries_space_id_spreadsheets_folders_folder_id_assets_body

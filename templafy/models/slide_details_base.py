...
T = TypeVar("T", bound="SlideDetailsBase")


@_attrs_define
class SlideDetailsBase:
    """
    Attributes:
        asset_type (str):
        ...
        navigation_path (str): Hierarchical path in lowercase based on the location of a slide. E.g.
            "folder-a/folder-b/_my-slide" when the location is "Folder A > Folder B > My Slide"

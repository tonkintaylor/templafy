...
T = TypeVar("T", bound="PatchLibrariesSpaceIdSpreadsheetsAssetsAssetIdBody")


@_attrs_define
class PatchLibrariesSpaceIdSpreadsheetsAssetsAssetIdBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        patch_libraries_space_id_spreadsheets_assets_asset_id_body = cls(
            folder_id=folder_id,
            name=name,
        ...
        patch_libraries_space_id_spreadsheets_assets_asset_id_body.additional_properties = d

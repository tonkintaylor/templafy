...
class DataSource:
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        for fields_item_data in self.fields:
            ...
            if isinstance(fields_item_data, TextFieldSchema):
                fields_item = fields_item_data.to_dict()
            elif isinstance(fields_item_data, NumberFieldSchema):
                fields_item = fields_item_data.to_dict()
            elif isinstance(fields_item_data, ReferenceFieldSchema):
                fields_item = fields_item_data.to_dict()
            elif isinstance(fields_item_data, ImageFieldSchema):
                fields_item = fields_item_data.to_dict()
            elif isinstance(fields_item_data, LanguageFieldSchema):
                fields_item = fields_item_data.to_dict()
            elif isinstance(fields_item_data, FontFieldSchema):
                fields_item = fields_item_data.to_dict()
            else:
                fields_item = fields_item_data.to_dict()

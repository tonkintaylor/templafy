...
T = TypeVar("T", bound="NumberFieldSchema")
...
class NumberFieldSchema:
    """
    Example:
        {'id': 1, 'name': 'NumberOfOffices', 'type': 'number', 'isRequired': True, 'isLocked': False, 'defaultValue': 1}
    ...
    is_locked: bool
    is_required: bool
    default_value: Union[None, Unset, float] = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        default_value: Union[None, Unset, float]
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_default_value(data: object) -> Union[None, Unset, float]:
            if data is None:
                return data
        ...
        number_field_schema.additional_properties = d
        return number_field_schema

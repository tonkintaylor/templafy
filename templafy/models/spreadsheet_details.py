...
T = TypeVar("T", bound="SpreadsheetDetails")
...
class SpreadsheetDetails:
    ...
    Attributes:
        ...
        navigation_path (str): Hierarchical path in lowercase based on the location of a spreadsheet. E.g.
            "folder-a/folder-b/_my-spreadsheet" when the location is "Folder A > Folder B > My Spreadsheet"

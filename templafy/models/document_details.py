...
T = TypeVar("T", bound="DocumentDetails")
...
class DocumentDetails:
    ...
    Attributes:
        ...
        navigation_path (str): Hierarchical path in lowercase based on the location of a document. E.g.
            "folder-a/folder-b/_my-document" when the location is "Folder A > Folder B > My Document"

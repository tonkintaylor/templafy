...
T = TypeVar("T", bound="PatchReferenceDataSourceItemFieldRequest")


@_attrs_define
class PatchReferenceDataSourceItemFieldRequest:
    """
    Example:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        patch_reference_data_source_item_field_request = cls(
            type_=type_,
            data_source_field_id=data_source_field_id,
            data_source_item_id=data_source_item_id,
        )

        patch_reference_data_source_item_field_request.additional_properties = d
        return patch_reference_data_source_item_field_request

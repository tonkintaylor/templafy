...
class DataSourceObjectLockedProblemDetails:
    ...
    dependencies: Union[None, Unset, list["Dependency"]] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_dependencies(data: object) -> Union[None, Unset, list["Dependency"]]:
            if data is None:
                return data
            ...
            try:
                ...
                for dependencies_type_0_item_data in _dependencies_type_0:
                    dependencies_type_0_item = Dependency.from_dict(dependencies_type_0_item_data)
                ...
                pass
            return cast(Union[None, Unset, list["Dependency"]], data)

...
T = TypeVar("T", bound="PatchLibrariesSpaceIdSlideElementsAssetsAssetIdBody")


@_attrs_define
class PatchLibrariesSpaceIdSlideElementsAssetsAssetIdBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        patch_libraries_space_id_slide_elements_assets_asset_id_body = cls(
            folder_id=folder_id,
            name=name,
        ...
        patch_libraries_space_id_slide_elements_assets_asset_id_body.additional_properties = d
        return patch_libraries_space_id_slide_elements_assets_asset_id_body

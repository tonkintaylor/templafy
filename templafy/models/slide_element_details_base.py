...
T = TypeVar("T", bound="SlideElementDetailsBase")


@_attrs_define
class SlideElementDetailsBase:
    """
    Attributes:
        asset_type (str):
        ...
        navigation_path (str): Hierarchical path in lowercase based on the location of a slide element. E.g.
            "folder-a/folder-b/_my-slide-element" when the location is "Folder A > Folder B > My Slide Element"
    ...
    small_preview_link: Union[None, Unset, str] = UNSET
    large_preview_link: Union[None, Unset, str] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_small_preview_link(data: object) -> Union[None, Unset, str]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        def _parse_large_preview_link(data: object) -> Union[None, Unset, str]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        slide_element_details_base = cls(
        ...
        return slide_element_details_base

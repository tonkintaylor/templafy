...
T = TypeVar("T", bound="PatchLibrariesSpaceIdPresentationsAssetsAssetIdBody")


@_attrs_define
class PatchLibrariesSpaceIdPresentationsAssetsAssetIdBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        patch_libraries_space_id_presentations_assets_asset_id_body = cls(
            folder_id=folder_id,
            name=name,
        ...
        patch_libraries_space_id_presentations_assets_asset_id_body.additional_properties = d

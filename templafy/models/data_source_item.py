...
if TYPE_CHECKING:
    from templafy.models.data_source_color_theme_item_field import DataSourceColorThemeItemField
    ...
    from templafy.models.data_source_language_item_field import DataSourceLanguageItemField
    from templafy.models.data_source_number_item_field import DataSourceNumberItemField
    from templafy.models.data_source_reference_item_field import DataSourceReferenceItemField
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.fields, Unset):
            ...
            for fields_type_0_item_data in self.fields:
                ...
                if isinstance(fields_type_0_item_data, DataSourceTextItemField):
                    fields_type_0_item = fields_type_0_item_data.to_dict()
                elif isinstance(fields_type_0_item_data, DataSourceNumberItemField):
                    fields_type_0_item = fields_type_0_item_data.to_dict()
                elif isinstance(fields_type_0_item_data, DataSourceReferenceItemField):
                    fields_type_0_item = fields_type_0_item_data.to_dict()
                elif isinstance(fields_type_0_item_data, DataSourceImageItemField):
                    fields_type_0_item = fields_type_0_item_data.to_dict()
                elif isinstance(fields_type_0_item_data, DataSourceLanguageItemField):
                    fields_type_0_item = fields_type_0_item_data.to_dict()
                elif isinstance(fields_type_0_item_data, DataSourceFontItemField):
                    fields_type_0_item = fields_type_0_item_data.to_dict()
                else:
                    fields_type_0_item = fields_type_0_item_data.to_dict()
                    ...
                    def _parse_fields_type_0_item(
                        ...
                        try:
                            if not isinstance(data, dict):
                                raise TypeError()
                            fields_type_0_item_type_0 = DataSourceTextItemField.from_dict(data)
                        ...
                        try:
                            if not isinstance(data, dict):
                                raise TypeError()
                            fields_type_0_item_type_1 = DataSourceNumberItemField.from_dict(data)
                        ...
                        try:
                            if not isinstance(data, dict):
                                raise TypeError()
                            fields_type_0_item_type_2 = DataSourceReferenceItemField.from_dict(data)
                        ...
                        try:
                            if not isinstance(data, dict):
                                raise TypeError()
                            fields_type_0_item_type_3 = DataSourceImageItemField.from_dict(data)
                        ...
                        try:
                            if not isinstance(data, dict):
                                raise TypeError()
                            fields_type_0_item_type_4 = DataSourceLanguageItemField.from_dict(data)
                        ...
                        try:
                            if not isinstance(data, dict):
                                raise TypeError()
                            fields_type_0_item_type_5 = DataSourceFontItemField.from_dict(data)
                        ...
                        if not isinstance(data, dict):
                            raise TypeError()
                        fields_type_0_item_type_6 = DataSourceColorThemeItemField.from_dict(data)

...
class PdfDetails:
    ...
    Attributes:
        ...
        navigation_path (str): Hierarchical path in lowercase based on the location of a pdf. E.g.
            "folder-a/folder-b/_my-pdf" when the location is "Folder A > Folder B > My Pdf"
